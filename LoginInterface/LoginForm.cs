...
namespace LoginInterface
{
    public partial class LoginForm : Form
    {
        ...
        private void Login()
        {
            ...
            RoleIdentifier role = new RoleIdentifier(username, password);
            switch (role.RoleOfUser())
            {
                case "Admin":
                    HomePage_Admin homePage_Admin = new HomePage_Admin(username, password);
                    homePage_Admin.Show();
                    break;
                case "Receptionist":
                ...
                case "Student":
                    ...
                    break;
                case "Tutor":
                    HomePageTutor tutor = new HomePageTutor(username, password);
                    tutor.Show();
                    break;
                default:
                    Notification noti = new Notification("Incorrect username or password");
                    noti.Show();
                    break;
            }
        }
